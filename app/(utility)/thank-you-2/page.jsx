...
export default function ThankYouPage() {
    ...
    return (<>
      ...
      <Box p="relative" h="100vh" w="100vw">
        <AbsoluteCenter>
          <VStack>
            <EmptyState icon={<EnvelopeOpen />} title="Du hast es fast geschafft!" description="Wir haben dir eine E-Mail geschickt, um deine Anmeldung für das SNT-Mentorship abzuschließen und dein Passwort zu setzen. Solltest du keine E-Mail erhalten haben, prüfe bitte auch deinen Spam-Ordner.">
