...
import { Button, Heading, Text, VStack, Box, Center, Dialog, Input, Stack, } from "@chakra-ui/react";
...
export default function RessourcenBibliothekPage() {
    ...
    return (<>
      ...
      <Section header size="lg" bg="bg.subtle" borderBottom="1px solid" borderColor="border" w="100vw" mx="unset" pb={{ base: "0px", md: "80px" }} position="relative" overflow="hidden">
        {/* Video Background */}
        <Box position="absolute" top="60%" left="50%" width="100vw" height={{ base: "50vh", md: "100vh" }} transform="translate(-50%, -50%)" zIndex={0} overflow="hidden">
          <video style={{
            width: "100%",
            height: "100%",
            objectFit: "cover",
        ...
        <VStack gap="4" maxW="900px" mx="auto" position="relative" zIndex={1}>
          <Stack gap="2" textAlign="center" mx="auto">
            ...
            <Box display="flex" alignItems="center" justifyContent="center" gap="2" mx="auto" mb="1">
              <CheckCircle size={20} color="#1E88E5" weight="fill"/>
                             <Heading as="h1" fontSize={{ base: "md", md: "2xl" }} fontWeight="700" lineHeight="0.9" color="white" textShadow="1px 1px 2px rgba(0,0,0,0.8)">
                 SNTTRADES™
               </Heading>
            </Box>
            
            <Heading as="h1" textStyle={{ base: "2xl", md: "5xl" }} mx="auto" color="white" lineHeight="tighter" fontWeight="semibold" maxW="800px" textShadow="2px 2px 4px rgba(0,0,0,0.8)">
              DEIN KOMPLETTER{' '}
              <Box as="span" background="linear-gradient(90deg,rgb(92, 154, 246), transparent 95%)" color="white" px={2} py={1} borderRadius="md" fontWeight="semibold" display="inline-block">
                TRADING-STARTPLATZ
              </Box>
            </Heading>
          ...
          <Stack align="center" direction={{ base: "column", md: "row" }} gap="3">
            <Button size="xl" fontWeight="bold" colorScheme="blue" bg="#1E88E5" _hover={{ bg: "#1565C0" }} borderRadius="md" px="8" onClick={() => setOpen(true)}>
       ...
       <Section size="md" bg="white" py={{ base: 4, md: 8 }}>
         <VStack gap="0" textAlign="center" maxW="4xl" mx="auto">
           <Heading as="h2" textStyle={{ base: "3xl", md: "4xl" }} color="gray.900" lineHeight="tight" mb="1">
             Was dich in der{' '}
           ...
           {/* Pfeil nach unten */}
           <Box fontSize="xl" color="#1E88E5" mt="0" animation="bounce 2s infinite">
             ⬇️
           </Box>
         </VStack>
       ...
       {/* Content Boxes für die drei Ressourcen */}
         <VStack gap={8} align="stretch" maxW="4xl" mx="auto" mt={{ base: "8", md: "16" }}>
            <VStack gap={8} align="stretch">
              ...
              <Box bg="white" borderRadius="2xl" boxShadow="lg" overflow="hidden" border="1px solid" borderColor="blue.100" _hover={{
            transform: "translateY(-4px)",
            boxShadow: "2xl",
            borderColor: "blue.200"
        }} transition="all 0.3s ease">
                {/* Header mit Gradient */}
                <Box bg="linear-gradient(135deg, #1E88E5, #60A5FA)" p={{ base: 4, md: 6 }} color="white">
                  <Box display="flex" alignItems="center" gap="3">
                    <Box bg="rgba(255, 255, 255, 0.2)" borderRadius="lg" p="3" backdropFilter="blur(10px)">
              ...
              <Box bg="white" borderRadius="2xl" boxShadow="lg" overflow="hidden" border="1px solid" borderColor="orange.100" _hover={{
            transform: "translateY(-4px)",
            boxShadow: "2xl",
            borderColor: "orange.200"
        }} transition="all 0.3s ease">
                {/* Header mit Gradient */}
                <Box bg="linear-gradient(135deg, #FF6B35, #FF8E53)" p={{ base: 4, md: 6 }} color="white">
                  <Box display="flex" alignItems="center" gap="3">
                    <Box bg="rgba(255, 255, 255, 0.2)" borderRadius="lg" p="3" backdropFilter="blur(10px)">
              ...
              <Box bg="white" borderRadius="2xl" boxShadow="lg" overflow="hidden" border="1px solid" borderColor="green.100" _hover={{
            transform: "translateY(-4px)",
            boxShadow: "2xl",
            borderColor: "green.200"
        }} transition="all 0.3s ease">
                {/* Header mit Gradient */}
                <Box bg="linear-gradient(135deg, #10B981, #34D399)" p={{ base: 4, md: 6 }} color="white">
                  <Box display="flex" alignItems="center" gap="3">
                    <Box bg="rgba(255, 255, 255, 0.2)" borderRadius="lg" p="3" backdropFilter="blur(10px)">
                      <Text fontSize="2xl">📱</Text>
                    </Box>
          ...
          <Center mt={8}>
            <Button size="xl" fontWeight="bold" colorScheme="blue" bg="#1E88E5" _hover={{ bg: "#1565C0" }} borderRadius="lg" px="12" py="8" fontSize="lg" onClick={() => setOpen(true)}>
      ...
      <Dialog.Root open={open} onOpenChange={(e) => setOpen(e.open)}>
        ...
        <Dialog.Backdrop />
          <Dialog.Positioner>
            <Dialog.Content borderRadius={{ base: "lg", md: "2xl" }} p={{ base: 4, md: 6 }} maxW={{ base: "90vw", md: "md" }} mx="auto" position="relative" minH={{ base: "auto", md: "auto" }}>
              ...
              <Box mb={{ base: 4, md: 6 }}>
                <Box position="relative" overflow="hidden" borderRadius="full" bg="gray.200" h="2">
                  ...
                  <Box position="absolute" left="0" top="0" h="100%" w="80%" bg="linear-gradient(90deg, #1E88E5, #60A5FA, #3B82F6)" borderRadius="full" boxShadow="0 0 8px rgba(30, 136, 229, 0.5)" animation="pulse 2s ease-in-out infinite" transition="all 0.3s ease" _hover={{
            ...
            transform: "scaleY(1.2)",
                ...
                <Box display="flex" justifyContent="space-between" alignItems="center" mt="3">
                  ...
                  <Box display="flex" gap="1" alignItems="center">
                    <Box w="1.5" h="1.5" bg="blue.400" borderRadius="full" animation="pulse 1.2s ease-in-out infinite"/>
                    <Box w="1.5" h="1.5" bg="blue.500" borderRadius="full" animation="pulse 1.2s ease-in-out infinite" style={{ animationDelay: "0.2s" }}/>
                    <Box w="1.5" h="1.5" bg="blue.600" borderRadius="full" animation="pulse 1.2s ease-in-out infinite" style={{ animationDelay: "0.4s" }}/>
                  </Box>
                ...
                <form onSubmit={handleSubmit}>
                  <VStack gap={{ base: 3, md: 4 }}>
                    <Box w="100%">
                      ...
                      <Input ref={initialRef} name="FirstName" placeholder="Dein Name..." value={form.FirstName} onChange={handleChange} size={{ base: "md", md: "lg" }}/>
                      {errors.FirstName && (<Text color="red.500" fontSize="sm" mt={1}>{errors.FirstName}</Text>)}
                    </Box>
                    ...
                    <Box w="100%">
                      ...
                      <Input name="Email" type="email" placeholder="Deine E-Mail..." value={form.Email} onChange={handleChange} size={{ base: "md", md: "lg" }}/>
                    ...
                    <Box w="100%">
                      ...
                      <Input name="Phone" placeholder="Deine Telefonnummer..." value={form.Phone} onChange={handleChange} size={{ base: "md", md: "lg" }}/>
                    </Box>
                    
                    <Button colorScheme="blue" size={{ base: "md", md: "lg" }} width="100%" type="submit" mt={{ base: 2, md: 4 }} loading={isLoading}>
                      {isLoading ? "Wird gesendet..." : "Zugang zur Ressourcen-Bibliothek sichern 📈"}
                    </Button>
                  </VStack>
                </form>
                
                <Text fontSize={{ base: "xs", md: "sm" }} color="gray.400" mt={{ base: 3, md: 4 }} textAlign="center" lineHeight="shorter">
