  ...
  return (
    <>
      ...
      <Box w="full" bg="white" py={{ base: 10, md: 20 }} px={{ base: 4, md: 8 }}>
        <VStack gap={8} maxW="6xl" mx="auto" align="stretch">
          ...
          Bring dein Trading aufs{' '}
            <Box as="span" 
              background="linear-gradient(90deg,rgb(246, 236, 92), transparent 105%)" 
              color="black" 
              px={2} 
              py={1} 
              borderRadius="md" 
      ...
      <Box
        minH="60vh"
        w="full"
        background="linear-gradient(135deg, rgb(7, 23, 36) 60%,rgb(23, 89, 143) 100%)"
        display="flex"
        alignItems="center"
        justifyContent="center"
        px={{ base: 4, md: 0 }}
            ...
            >
              ...
              >
                <Box
                  borderRadius="16px"
                  overflow="hidden"
                  background="radial-gradient(at 0% 100%,rgba(13, 112, 182, 0.4) 0px, transparent 50%),radial-gradient(at 100% 100%,rgba(148, 39, 238, 0.5) 0px, transparent 50%)"
                  p="2"
                >
      ...
      <Box 
        w="full" 
        background="linear-gradient(135deg, rgb(7, 23, 36) 0%, rgb(23, 89, 143) 100%)"
        py={{ base: 12, md: 20 }} 
        px={2}
      >
