...
export const metadata = generateMetadata({
    ...
    description: "See how the lead capture embed works in both popup and embedded modes",
});
export default function LeadCaptureEmbedPage() {
    return (<>
      <Section header bg="bg.muted" borderBottomColor="border" borderBottomWidth="1px">
