...
import { Question, Ticket, EnvelopeSimple, BookOpen, VideoCamera, Users, CreditCard, Shield, Lifebuoy, } from "@phosphor-icons/react/dist/ssr";
...
export default function SupportPage() {
    ...
    return (<>
      ...
      <Section header bg="linear-gradient(135deg, rgba(0, 0, 0, 0.98), rgba(5, 10, 20, 0.95))" borderBottomColor="rgba(6, 140, 239, 0.25)" borderBottomWidth="1px" position="relative" _before={{
            content: '""',
            position: "absolute",
            top: 0,
            left: 0,
          ...
          <VStack gap={{ base: "5", md: "6" }}>
            <VStack gap={{ base: "3", md: "4" }}>
              <Box display="flex" alignItems="center" justifyContent="center" gap="3">
                <Box p={3} borderRadius="full" bg="rgba(6, 140, 239, 0.15)" border="1px solid rgba(6, 140, 239, 0.3)" boxShadow="0 4px 12px rgba(6, 140, 239, 0.2)">
                  <Icon as={Lifebuoy} boxSize={8} color={SNT_BLUE}/>
                </Box>
                <Heading as="h1" textStyle={{ base: "4xl", md: "5xl" }} color="white" textShadow="0 2px 4px rgba(0,0,0,0.3)">
                  Hilfe & Support
                </Heading>
              </Box>
            </VStack>
            <Text color="gray.200" textStyle={{ base: "lg", md: "xl" }} maxW="2xl" lineHeight="1.6">
      ...
      {/* Hilfe-Kategorien */}
      <Section bg="linear-gradient(135deg, rgba(5, 10, 20, 0.98), rgba(0, 0, 0, 0.95))" position="relative" _before={{
            content: '""',
            position: "absolute",
            top: 0,
            left: 0,
        ...
        <Container maxW="7xl" position="relative" zIndex={1}>
          <VStack gap="8">
            <Heading as="h2" textStyle="2xl" textAlign="center" color="white" textShadow="0 2px 4px rgba(0,0,0,0.3)">
              Wie können wir Ihnen helfen?
            </Heading>
            <SimpleGrid columns={{ base: 1, md: 2, lg: 3 }} gap="6" w="full">
              {helpCategories.map((category, index) => (<Box key={index} p="6" bg="rgba(5, 10, 20, 0.7)" backdropFilter="blur(16px)" border="1px solid rgba(6, 140, 239, 0.25)" borderRadius="xl" cursor="pointer" _hover={{
                transform: "translateY(-4px)",
                boxShadow: "0 12px 40px 0 rgba(6, 140, 239, 0.25)",
                borderColor: "rgba(6, 140, 239, 0.4)"
            }} transition="all 0.3s ease" onClick={scrollToTicket}>
      ...
      {/* FAQ-Bereich */}
      <Section bg="linear-gradient(135deg, rgba(0, 0, 0, 0.95), rgba(5, 10, 20, 0.98))" position="relative" _before={{
            content: '""',
            position: "absolute",
            top: 0,
            left: 0,
        ...
        <Container maxW="4xl" position="relative" zIndex={1}>
          <VStack gap="8">
            <VStack gap="4" textAlign="center">
              ...
              <Heading as="h2" textStyle="2xl" color="white" textShadow="0 2px 4px rgba(0,0,0,0.3)">
            ...
            <VStack gap="4" w="full">
              {faqData.map((faq, index) => (<Box key={index} w="full" bg="rgba(5, 10, 20, 0.7)" backdropFilter="blur(16px)" border="1px solid rgba(6, 140, 239, 0.25)" borderRadius="xl" p="6" _hover={{
                borderColor: "rgba(6, 140, 239, 0.4)",
                boxShadow: "0 8px 32px 0 rgba(6, 140, 239, 0.15)"
                  ...
                  <VStack gap="3" align="stretch">
                    ...
                    {faq.question === "Ich habe keine Zugangsdaten erhalten?" && (<Box textAlign="center" pt="2">
                        <Box as="button" px="4" py="2" bg={SNT_BLUE} color="white" borderRadius="md" fontSize="sm" fontWeight="medium" cursor="pointer" _hover={{ bg: "#0572c2" }} transition="background-color 0.2s" onClick={scrollToTicket} boxShadow="0 4px 12px rgba(6, 140, 239, 0.3)">
                          Ticket öffnen
                        </Box>
                      </Box>)}
                  </VStack>
      ...
      {/* Ticket-System */}
      <Section bg="linear-gradient(135deg, rgba(5, 10, 20, 0.95), rgba(0, 0, 0, 0.98))" position="relative" _before={{
            content: '""',
            position: "absolute",
            top: 0,
            left: 0,
        ...
        <Container maxW="4xl" position="relative" zIndex={1}>
          <VStack gap="8" ref={ticketSectionRef}>
            ...
            <Box bg="rgba(5, 10, 20, 0.8)" backdropFilter="blur(20px)" border="1px solid rgba(6, 140, 239, 0.3)" borderRadius="xl" p="8" w="full" boxShadow="0 20px 60px 0 rgba(6, 140, 239, 0.2)">
              <Support />
            </Box>
          </VStack>
        </Container>
      ...
      <Section bg="linear-gradient(135deg, rgba(0, 0, 0, 0.98), rgba(5, 10, 20, 0.95))" position="relative" _before={{
            content: '""',
            position: "absolute",
            top: 0,
            left: 0,
        ...
        <Container maxW="6xl" position="relative" zIndex={1}>
          <VStack gap="8">
            ...
            <SimpleGrid columns={{ base: 1, md: 2 }} gap="6" w="full">
              <Box bg="rgba(5, 10, 20, 0.7)" backdropFilter="blur(16px)" border="1px solid rgba(6, 140, 239, 0.25)" borderRadius="xl" p="6" textAlign="center" _hover={{
            transform: "translateY(-4px)",
            boxShadow: "0 12px 40px 0 rgba(6, 140, 239, 0.25)",
            borderColor: "rgba(6, 140, 239, 0.4)"
        }} transition="all 0.3s ease">
