...
import { Box, VStack, Heading, Text, HStack, SimpleGrid, } from "@chakra-ui/react";
import { Section } from "@/components/layout/section";
import SntHeroWaitlist from "@/components/hero/snt-hero-waitlist";
import { CheckCircle, ShieldCheck, Lightning, EnvelopeSimple, ChatsCircle } from "@phosphor-icons/react/dist/ssr";
...
export default function RegisterPage() {
    ...
    return (<>
      <Box id="register-page" position="relative" bg="#050709" _before={{
            content: '""',
            position: "absolute",
            inset: 0,
      ...
      <SntHeroWaitlist />
        ...
        <Box w="100%" position="relative" zIndex={1}>
          <Box h={{ base: 10, md: 12 }} position="relative" overflow="hidden">
            <Box position="absolute" top={0} left={0} right={0} bottom={0} bg="radial-gradient(55% 60% at 50% 0%, rgba(16,185,129,0.35) 0%, rgba(16,185,129,0.16) 35%, rgba(16,185,129,0.06) 60%, rgba(0,0,0,0) 70%)" filter="blur(14px)"/>
        ...
        <VStack gap={8} maxW="4xl" mx="auto">
          ...
          <VStack gap={6} align="stretch" maxW="4xl" mx="auto" mt={{ base: 4, md: 6 }}>
            <SimpleGrid columns={{ base: 1, md: 2 }} gap={{ base: 4, md: 6 }}>
              ...
              <Box bg="rgba(6, 12, 10, 0.55)" borderRadius="xl" border="1px solid" borderColor="rgba(16,185,129,0.35)" boxShadow="0 0 0 1px rgba(16,185,129,0.22), 0 20px 60px rgba(16,185,129,0.20)" p={{ base: 4, md: 5 }} backdropFilter="saturate(160%) blur(10px)" transition="all 0.25s ease" _hover={{ transform: "translateY(-4px)", boxShadow: "0 0 0 1px rgba(16,185,129,0.35), 0 30px 90px rgba(16,185,129,0.28)" }}>
          ...
          <Box w="100%" maxW="480px" mx="auto" bg="rgba(6, 12, 10, 0.55)" borderRadius="2xl" boxShadow="0 0 0 1px rgba(16,185,129,0.35), 0 0 60px rgba(16,185,129,0.25), 0 40px 120px rgba(16,185,129,0.28)" p={{ base: 5, md: 6 }} border="1px solid" borderColor="rgba(16,185,129,0.45)" backdropFilter="saturate(180%) blur(14px)">
            {/* Widget Header */}
            <VStack gap={4} mb={6} textAlign="center">
              <Box bg="linear-gradient(135deg, #10B981, #22C55E)" borderRadius="full" p={4} color="white">
            ...
            {/* Outseta Widget */}
            <Box id="outseta-widget-container" minH="360px" display="flex" alignItems="center" justifyContent="center">
             <div data-o-email-list="1" data-mode="embed" data-email-list-uid="E9LwOvQw" data-registration-field-configuration='[
  {
    "defaultValue": "",
    "definition": {
      "SystemName": "Email"
