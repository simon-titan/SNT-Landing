...
export default function SntHeroWaitlist() {
    ...
    return (<Box position="relative" w="100%" h={{ base: "28vh", md: "40vh" }} background="#000" overflow="hidden">
      <Box as="canvas" ref={canvasRef} position="absolute" inset={0} w="100%" h="100%"/>

      <VStack position="absolute" top="50%" left="50%" transform="translate(-50%, -50%)" gap={{ base: 2, md: 3 }} w="full" maxW="900px" px={{ base: 3, md: 6 }} zIndex={1}>
        <Heading as="h1" color={GREEN} textAlign="center" fontFamily="var(--font-horizon), Inter, system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif" fontWeight="1000" textShadow="0 0 26px rgba(73,231,156,0.85), 0 0 66px rgba(73,231,156,0.4)" fontSize={{ base: "5xl", md: "7xl" }} lineHeight="1" animation={`${keyframes({
        ...
        <Box w={{ base: "80px", md: "110px" }} h={{ base: "1px", md: "2px" }} bg={`linear-gradient(90deg, rgba(73,231,156,0) 0%, rgba(73,231,156,0.95) 50%, rgba(73,231,156,0) 100%)`} borderRadius="full" boxShadow="0 0 10px rgba(73,231,156,0.7), 0 0 24px rgba(73,231,156,0.35)"/>

        <Heading as="h2" textAlign="center" color="white" fontWeight="semibold" fontSize={{ base: "sm", md: "lg" }} lineHeight="1.3" maxW={{ base: "90%", md: "70%" }} textShadow="0 1px 2px rgba(0,0,0,0.55)">
          SICHER DIR JETZT DEINEN <br></br>{' '}
          <Box as="span" color="white" px="1.5" borderRadius="xs" bg="linear-gradient(90deg, rgba(73,231,156,0.6), rgba(73,231,156,0.22) 85%, rgba(73,231,156,0) 100%)">
            SNT-ELITE PLATZ
          </Box>
