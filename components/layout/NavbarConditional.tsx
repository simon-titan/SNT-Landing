...
export default function NavbarConditional() {
  ...
  if (pathname.startsWith("/checkout") || pathname.startsWith("/choose-platform") || pathname.startsWith("/legal") || pathname.startsWith("/telegram") || pathname.startsWith("/thank-you-3")) return null;
