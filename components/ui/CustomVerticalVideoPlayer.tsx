...
interface CustomVerticalVideoPlayerProps {
  src: string; // Videoquelle (z.B. mp4-URL)
  poster?: string;
  title?: string;
}

export const CustomVerticalVideoPlayer: React.FC<CustomVerticalVideoPlayerProps> = ({ src, poster, title }) => {
  ...
  return (
    ...
    >
      ...
      {title && (
        <Box fontWeight="medium" fontSize="md" p={3} textAlign="center">
          {title}
        </Box>
      )}
    </Box>
