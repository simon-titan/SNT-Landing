export const projectConfig = {
    ...
    outsetaOptions: {
        ...
        auth: {
            ...
            postRegistrationUrl: process.env.NODE_ENV === "production"
                ? "https://project-rocket.danielwirtz.com/thank-you"
                : "http://localhost:3000/thank-you",
            /** URL to redirect after successful authentication */
            authenticationCallbackUrl: process.env.NODE_ENV === "production"
...
-----END CERTIFICATE-----`,
    ...
    cookieBannerOptions: {
        ...
        language: {
            ...
            translations: {
                en: {
                    consentModal: {
                        description: "We use cookies to improve your experience and understand site traffic. Read our <a href='/legal/cookie-policy'>Cookie Policy</a> or <a data-cc='show-preferencesModal'>manage your preferences</a>.",
    ...
    seo: {
        ...
        defaultDescription: "A powerful starter template for building web applications with Next.js, Chakra UI, and Outseta",
