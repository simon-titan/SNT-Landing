    ...
    theme: {
        ...
        semanticTokens: {
            ...
            shadows: {
                xs: {
                    value: {
                        _light: "0px 1px 2px {colors.neutral.900/10}, 0px 0px 1px {colors.neutral.900/20}",
                        _dark: "0px 1px 1px {black/64}, 0px 0px 1px inset {colors.neutral.300/20}",
                    },
                },
                sm: {
                    value: {
                        _light: "0px 2px 4px {colors.neutral.900/10}, 0px 0px 1px {colors.neutral.900/30}",
                        _dark: "0px 2px 4px {black/64}, 0px 0px 1px inset {colors.neutral.300/30}",
                    },
                },
                md: {
                    value: {
                        _light: "0px 4px 8px {colors.neutral.900/10}, 0px 0px 1px {colors.neutral.900/30}",
                        _dark: "0px 4px 8px {black/64}, 0px 0px 1px inset {colors.neutral.300/30}",
                    },
                },
                lg: {
                    value: {
                        _light: "0px 8px 16px {colors.neutral.900/10}, 0px 0px 1px {colors.neutral.900/30}",
                        _dark: "0px 8px 16px {black/64}, 0px 0px 1px inset {colors.neutral.300/30}",
                    },
                },
                xl: {
                    value: {
                        _light: "0px 16px 24px {colors.neutral.900/10}, 0px 0px 1px {colors.neutral.900/30}",
                        _dark: "0px 16px 24px {black/64}, 0px 0px 1px inset {colors.neutral.300/30}",
                    },
                },
                "2xl": {
                    value: {
                        _light: "0px 24px 40px {colors.neutral.900/16}, 0px 0px 1px {colors.neutral.900/30}",
                        _dark: "0px 24px 40px {black/64}, 0px 0px 1px inset {colors.neutral.300/30}",
                    },
                },
                inner: {
                    value: {
...
function getBorderRadiusValue(selected, offset) {
    const values = [
        "none",
        "2xs",
        "xs",
    ...
    const targetIndex = Math.max(0, Math.min(values.length - 1, selectedIndex + offset));
